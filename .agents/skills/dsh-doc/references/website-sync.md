...
- `source`: repository-relative canonical Markdown path, added through `manifestPages()`.
...
Each English source projects to its locale-prefixed route through `manifestPages()`.
