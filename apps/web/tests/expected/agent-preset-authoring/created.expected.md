- dialog "Settings":
  ...
  - list:
    - listitem:
      ...
      - 'button "Duplicate: Standard mode"':
        ...
        - text: Duplicate
    - listitem:
      - 'button "Set as default: PTC mode"':
        - text: PTC mode Built-in Full coding agent without the workflow tool; other tools are exposed through the PTC mode SDK so the model can combine multi-step operations in one TypeScript program.
        - code: ptc
      - 'button "View: PTC mode"':
        - img
        - text: View
      - 'button "Duplicate: PTC mode"':
        - img
        - text: Duplicate
    - listitem:
  ...
  - list:
    - listitem:
      - 'button "Set as default: My Mode"':
        - text: My Mode Custom Two-tool coding agent with persistent bash and str_replace_editor.
        - code: my-agent
      - 'button "Show location: My Mode"':
        - img
        - text: Show location
      - 'button "Duplicate: My Mode"':
        - img
        - text: Duplicate
      - 'button "Delete: My Mode"':
        - img
        - text: Delete
      - paragraph:
        - text: Preset files:
