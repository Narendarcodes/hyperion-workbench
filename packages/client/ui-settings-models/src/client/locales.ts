...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  create: '创建提供方',
  creating: '创建中\u2026',
  welcomeTitle: '开发者预览声明',
  welcomeBody: 'HYPERION 是面向机密工业工作的本地智能体 AI 工作台，构建于开源 DeepSeek Harness 智能体运行时之上。当前开发者预览版仍处在测试阶段，还有许多地方需要持续改进和打磨，核心插件与基础 API 也会在接下来一段时间内快速迭代、持续演化。\n\n在本地使用受控模型、证据支撑的知识、有边界的工具与人工核验来分析机密信息。上游归属、许可证与安全说明仍归 DeepSeek Harness 项目所有。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '连接模型以开始使用',
  onboardingDescription: '启动本地模型服务或配置模型提供方，开始工作。',
