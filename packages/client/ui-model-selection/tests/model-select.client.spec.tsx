...
describe('ModelSelect reasoning effort', () => {
  it('renders effort names without descriptions and submits the effort as part of the session selection', async () => {
    ...
    fireEvent.click(screen.getByRole('menuitem', { name: 'EffortHigh' }))
  ...
  it('shows the durable model id when the catalog has no matching display name', () => {
    ...
    fireEvent.click(screen.getByRole('menuitem', { name: 'Modeldeepseek-official/removed-model' }))
  ...
  it('announces a rejected selection as a transient toast and keeps the in-menu strip for loads', async () => {
    ...
    fireEvent.click(screen.getByRole('menuitem', { name: 'ModelDeepSeek-V4-Flash' }))
