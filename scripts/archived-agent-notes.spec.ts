...
describe('archived Agent Notes', () => {
  ...
  it('accepts one complete implemented pair with matching archive metadata', () => {
    expect(validateArchiveArtifacts(fixture())).toEqual([])
  })

  it('rejects incomplete pairs and invalid archive headers', () => {
